...
export const sendAdminNotification = async (contactMessage) => {
    ...
    await mailer.sendMail({
        from: `"VEXA Support Form" <${process.env.EMAIL_USER}>`,
        to: process.env.EMAIL_USER,
        replyTo: contactMessage.email,
        subject: `[VEXA Support] ${contactMessage.subject}`,
        html: `
            <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto;">
                ...
                <p style="white-space: pre-line; border-left: 3px solid #3B82F6; padding-left: 12px; margin-top: 16px;">${contactMessage.message}</p>
            </div>
        `,
    });
